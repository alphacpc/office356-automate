...
session.create_folder_on_onedrive("Maaaaa")

url_shared = session.share_folder("Lorems")

print(url_shared)

# session.create_folder_on_onedrive("Sonatel/data1/data01")
# session.share_folder("Sonatel/data1")